...
{
    [Header("Fusion")]
    [Tooltip("Bo�sa sahneden LevelManager otomatik bulunur.")]
    [SerializeField] private LevelManager levelManager;

    [Tooltip("Genelde sadece Host respawn etsin.")]
    [SerializeField] private bool onlyIfHost = true;

    [Tooltip("Topun collider� trigger olsun mu? (�stersen �arp��ma yerine trigger)")]
    ...
    // Trigger kullanmak istemezsen (col.isTrigger=false), bu da �al��s�n:
